...
# Generation Time: 2014-03-12 17:55:16 +0000
# ************************************************************
...
# Dump of table nm_device_identity
# ------------------------------------------------------------

CREATE TABLE `nm_device_identity` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `device_id` int(11) unsigned NOT NULL,
  `ipv4_address` varchar(15) NOT NULL DEFAULT '',
  `ipv4_last_hostname` varchar(255) DEFAULT NULL,
  `identity_status` int(11) NOT NULL DEFAULT '0',
  `last_update_date` timestamp NULL DEFAULT NULL,
  `modified_date` timestamp NULL DEFAULT NULL,
  `create_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `device_id` (`device_id`),
  CONSTRAINT `nm_device_identity_ibfk_1` FOREIGN KEY (`device_id`) REFERENCES `nm_device` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `nm_interface` (
  ...
  CONSTRAINT `nm_interface_ibfk_1` FOREIGN KEY (`probe_identity_id`) REFERENCES `nm_probe_identity` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `nm_interface_aggregated_stats` (
  ...
  PRIMARY KEY (`id`),
  KEY `probe_identity_id` (`probe_identity_id`),
  CONSTRAINT `nm_interface_aggregated_stats_ibfk_1` FOREIGN KEY (`probe_identity_id`) REFERENCES `nm_probe_identity` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
# Dump of table nm_probe_identity
# ------------------------------------------------------------

CREATE TABLE `nm_probe_identity` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `probe_id` int(11) unsigned NOT NULL,
  `identity_id` int(11) unsigned NOT NULL,
  `order_key` int(11) unsigned NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`),
  KEY `probe_id` (`probe_id`),
  KEY `identity_id` (`identity_id`),
  CONSTRAINT `nm_probe_identity_ibfk_1` FOREIGN KEY (`probe_id`) REFERENCES `nm_probe` (`id`),
  CONSTRAINT `nm_probe_identity_ibfk_2` FOREIGN KEY (`identity_id`) REFERENCES `nm_device_identity` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
